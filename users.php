            ...
            <form id="profile" action="" method="POST">
                <table>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="alma_mater" placeholder="出身校を入力する"></td>
                        </tr>
                        <tr>
                            <th><label for="home_address">居住地：</label></th>
                            <td><input type="text" name="home_address" placeholder="居住地を入力する"></td>
                        </tr>
                        <tr>
                            <th><label for="birth_place">出身地：</label></th>
                            <td><input type="text" name="birth_place" placeholder="出身地を入力する"></td>
                        </tr>
                        <tr>
